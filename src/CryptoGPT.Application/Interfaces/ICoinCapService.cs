...
namespace CryptoGPT.Application.Interfaces
{
    ...
    {
        /// <summary>
        /// Get top cryptocurrencies by market cap from CoinCap
        /// </summary>
        ...
        /// <summary>
        /// Get detailed information for a specific cryptocurrency from CoinCap
        /// </summary>
        ...
        /// <summary>
        /// Get historical market data for a cryptocurrency from CoinCap
        /// </summary>
        /// <param name="coinId">Coin identifier (e.g. "bitcoin")</param>
        ...
        /// <summary>
        /// Get market overview data from CoinCap
        /// </summary>
