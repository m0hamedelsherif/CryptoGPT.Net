...
{
    /// <summary>
    /// Implementation of ICoinGeckoService to access the CoinGecko API
    /// </summary>
    public class CoinGeckoService : ICoinGeckoService
    {
        ...
        public async Task<List<CryptoCurrency>> GetTopCoinsAsync(int limit = 10)
        {
            ...
            try
            {
                ...
                await _cacheService.SetAsync(cacheKey, result, TimeSpan.FromMinutes(5)); // 5 min
        ...
        public async Task<MarketOverview> GetMarketOverviewAsync()
        {
            ...
            return new MarketOverview
            {
                ...
                WorstPerformers = topLosers,
                TopByVolume = topByVolume,
                MarketMetrics = metrics,
                GeneratedAt = globalData.Data.UpdatedAt,
            };
        }
